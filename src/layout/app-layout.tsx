...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Auction', path: '/auctions', entity: 'auction', service: AccessServiceEnum.PROJECT, icon: FiDollarSign },
    {
      name: 'Fantasy Game',
      path: '/fantasy-games',
      entity: 'fantasy_game',
    ...
    { name: 'Score', path: '/scores', entity: 'score', service: AccessServiceEnum.PROJECT, icon: FiAward },
